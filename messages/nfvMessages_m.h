...
/**
 * Class generated from <tt>messages/nfvMessages.msg:2</tt> by opp_msgtool.
 * <pre>
 * packet NfvMessage
 * {
 * }
...
/**
 * Class generated from <tt>messages/nfvMessages.msg:6</tt> by opp_msgtool.
 * <pre>
...
/**
 * Class generated from <tt>messages/nfvMessages.msg:27</tt> by opp_msgtool.
 * <pre>
...
class VnfDeploymentResponse : public ::NfvMessage
{
  ...
  public:
    ...
    virtual double getAvailableCPU() const;
    virtual void setAvailableCPU(double availableCPU);

    virtual double getAvailableMemory() const;
    virtual void setAvailableMemory(double availableMemory);

    virtual double getAvailableBandwidth() const;
    virtual void setAvailableBandwidth(double availableBandwidth);
};
