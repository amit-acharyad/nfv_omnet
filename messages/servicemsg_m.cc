//
// Generated file, do not edit! Created by opp_msgtool 6.1 from messages/servicemsg.msg.
//
...
double ServiceChainAck::getAvailableCPU() const
{
    return this->availableCPU;
}

void ServiceChainAck::setAvailableCPU(double availableCPU)
{
    this->availableCPU = availableCPU;
}

double ServiceChainAck::getAvailableMemory() const
{
    return this->availableMemory;
}

void ServiceChainAck::setAvailableMemory(double availableMemory)
{
    this->availableMemory = availableMemory;
}

double ServiceChainAck::getAvailableBandwidth() const
{
    return this->availableBandwidth;
}

void ServiceChainAck::setAvailableBandwidth(double availableBandwidth)
{
...
int ServiceChainAckDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "availableCPU") == 0) return baseIndex + 4;
    if (strcmp(fieldName, "availableMemory") == 0) return baseIndex + 5;
    if (strcmp(fieldName, "availableBandwidth") == 0) return baseIndex + 6;
    return base ? base->findField(fieldName) : -1;
}
