//
// Generated file, do not edit! Created by opp_msgtool 6.1 from messages/nfvMessages.msg.
//
...
int VnfDeploymentRequest::getNfviNodeId() const
{
    return this->nfviNodeId;
}

void VnfDeploymentRequest::setNfviNodeId(int nfviNodeId)
{
...
int VnfDeploymentRequestDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "nfviNodeId") == 0) return baseIndex + 3;
    if (strcmp(fieldName, "cpuRequest") == 0) return baseIndex + 4;
    if (strcmp(fieldName, "memoryRequest") == 0) return baseIndex + 5;
    if (strcmp(fieldName, "bandwidthRequest") == 0) return baseIndex + 6;
    if (strcmp(fieldName, "vnfIpAddress") == 0) return baseIndex + 7;
    if (strcmp(fieldName, "firewallLbVip") == 0) return baseIndex + 8;
    if (strcmp(fieldName, "backendServerIps") == 0) return baseIndex + 9;
    return base ? base->findField(fieldName) : -1;
}
...
void VnfDeploymentResponse::copy(const VnfDeploymentResponse& other)
{
    ...
    this->availableBandwidth = other.availableBandwidth;
}
...
void VnfDeploymentResponse::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->availableCPU);
    doParsimPacking(b,this->availableMemory);
    doParsimPacking(b,this->availableBandwidth);
}
...
void VnfDeploymentResponse::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->availableCPU);
    doParsimUnpacking(b,this->availableMemory);
    doParsimUnpacking(b,this->availableBandwidth);
}
...
double VnfDeploymentResponse::getAvailableCPU() const
{
    return this->availableCPU;
}

void VnfDeploymentResponse::setAvailableCPU(double availableCPU)
{
    this->availableCPU = availableCPU;
}

double VnfDeploymentResponse::getAvailableMemory() const
{
    return this->availableMemory;
}

void VnfDeploymentResponse::setAvailableMemory(double availableMemory)
{
    this->availableMemory = availableMemory;
}

double VnfDeploymentResponse::getAvailableBandwidth() const
{
    return this->availableBandwidth;
}

void VnfDeploymentResponse::setAvailableBandwidth(double availableBandwidth)
{
...
class VnfDeploymentResponseDescriptor : public omnetpp::cClassDescriptor
{
  private:
    ...
    enum FieldConstants {
        ...
        FIELD_deployedVnfIp,
        FIELD_availableCPU,
        FIELD_availableMemory,
        FIELD_availableBandwidth,
    };
  public:
...
unsigned int VnfDeploymentResponseDescriptor::getFieldTypeFlags(int field) const
{
    ...
    static unsigned int fieldTypeFlags[] = {
        ...
        FD_ISEDITABLE,    // FIELD_availableCPU
        FD_ISEDITABLE,    // FIELD_availableMemory
        FD_ISEDITABLE,    // FIELD_availableBandwidth
    };
...
int VnfDeploymentResponseDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "nfviNodeId") == 0) return baseIndex + 2;
    if (strcmp(fieldName, "vnfName") == 0) return baseIndex + 3;
    if (strcmp(fieldName, "infoMessage") == 0) return baseIndex + 4;
    if (strcmp(fieldName, "deployedVnfIp") == 0) return baseIndex + 5;
    if (strcmp(fieldName, "availableCPU") == 0) return baseIndex + 6;
    if (strcmp(fieldName, "availableMemory") == 0) return baseIndex + 7;
    if (strcmp(fieldName, "availableBandwidth") == 0) return baseIndex + 8;
    return base ? base->findField(fieldName) : -1;
}
...
const char *VnfDeploymentResponseDescriptor::getFieldTypeString(int field) const
{
    ...
    static const char *fieldTypeStrings[] = {
        ...
        "double",    // FIELD_availableCPU
        "double",    // FIELD_availableMemory
        "double",    // FIELD_availableBandwidth
    };
...
std::string VnfDeploymentResponseDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_availableCPU: return double2string(pp->getAvailableCPU());
        case FIELD_availableMemory: return double2string(pp->getAvailableMemory());
        case FIELD_availableBandwidth: return double2string(pp->getAvailableBandwidth());
        default: return "";
    }
}
...
void VnfDeploymentResponseDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case FIELD_availableCPU: pp->setAvailableCPU(string2double(value)); break;
        case FIELD_availableMemory: pp->setAvailableMemory(string2double(value)); break;
        case FIELD_availableBandwidth: pp->setAvailableBandwidth(string2double(value)); break;
...
omnetpp::cValue VnfDeploymentResponseDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_availableCPU: return pp->getAvailableCPU();
        case FIELD_availableMemory: return pp->getAvailableMemory();
        case FIELD_availableBandwidth: return pp->getAvailableBandwidth();
...
void VnfDeploymentResponseDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    ...
    switch (field) {
        ...
        case FIELD_availableCPU: pp->setAvailableCPU(value.doubleValue()); break;
        case FIELD_availableMemory: pp->setAvailableMemory(value.doubleValue()); break;
        case FIELD_availableBandwidth: pp->setAvailableBandwidth(value.doubleValue()); break;
        default: throw omnetpp::cRuntimeError("Cannot set field %d of class 'VnfDeploymentResponse'", field);
    }
}
